                ...
                stats.forEach(function(stat) {
                    ...
                    const div = $(`
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card rounded-5" style="${stat.backgroun}" >
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                stats.forEach(function(stat) {
                    ...
                    const div = $(`
                        <div class="col" >
                            <div class="card pricing text-center rounded-5" style="${stat.backgroun}" >
    ...
    function stat_table()
    {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const div1 = $(`
                    <div class="nk-tb-list border border-1" id="div_table2" >
