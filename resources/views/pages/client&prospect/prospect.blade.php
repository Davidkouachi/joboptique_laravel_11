                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="observation" placeholder="Facultatif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="motif" placeholder="Facultatif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- <div class="col-md-6">
                                                    ...
                                                    <table class="datatable-init table_prospect " data-auto-responsive="false" style="font-size:12px;" >
                                                        <thead class="bg-azure" >
                                                            <tr class="nk-tb-item nk-tb-head">
                                                                ...
                                                                <th class="nk-tb-col" >
                                                                    <span class="sub-text text-white">Prospect</span>
                                                                </th>
                                                                {{-- <th class="nk-tb-col" >
...
<script src="{{asset('assets/app/js/list/list_prospect_all.js')}}"></script>
<script src="{{asset('assets/app/js/select.js')}}"></script>
<script src="{{asset('assets/app/js/insert/prospect.js')}}"></script>
