                                            ...
                                            <div class="tab-pane" id="new">
                                                <div class="card-title-group justify-content-center align-items-center mt-5">
                                                    <div class="card-title d-flex-column justify-content-center align-items-center text-center">
                                                        ...
                                                        <h4 class="title fw-normal">Nouvelle Assurances</h4>
                                                    </div>
                                                </div>
                                                <form id="formulaire_new_assurance" class="mt-5">
                                                    <div class="row g-gs">
                                                        <div class="col-12">
                                            ...
                                            <div class="tab-pane active" id="liste">
                                                <div class="card-title-group justify-content-center align-items-center mt-5">
                                                    <div class="card-title d-flex-column justify-content-center align-items-center text-center">
                                                        ...
                                                        <h4 class="title fw-normal">Liste des Assurances</h4>
                                                    </div>
                                                </div>
                                                <div class="table-responsive datatable-wrap p-2 mt-5">
                                                    <table class="datatable-init table_assurance" data-auto-responsive="false" style="font-size:12px;" >
                                                        <thead>
...
<script src="{{asset('assets/app/js/list/list_assurance_all.js')}}"></script>
<script src="{{asset('assets/app/js/insert/assurance.js')}}"></script>
